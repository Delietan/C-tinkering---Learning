...
int main ()  {                  //  Definerer vanlig int-array:
    ...
    printf("Arrayens forste verdi:   %i\n\n", *iPeker);
...
// ***************************************************************************
    ...
    printf("Arrayens aattende verdi:  %i\n\n", *iPeker);
...
//  Det samme, bare litt mer kompakt:
    ...
    printf("Verdi til peker naar lokke har stanset:  %i\n\n\n\n", *iPeker);
...
// ***************************************************************************
   ...
   printf("Gaar bare videre utover i memory - skriver alt som char'er:\n");
