...
// ***************************************************************************
    ...
    printf("Det %i forste Fibonacci-tallene:\n\t", FIBANT);
...
// ***************************************************************************
   ...
   printf("FYSJ OG FOY - Forsok paa utskrift av lokal variabel:  -%s-\n\n",
          tekst3);
...
// ***************************************************************************
   ...
   printf("Verdier FOR bytte:      %i   %i\n", tall, tall2);

   bytt(&tall, &tall2);
   printf("Verdier ETTER bytte:    %i   %i\n\n", tall, tall2);

   bytt(tPeker, tPeker2);
   printf("Verdier naar TILBAKE:   %i   %i\n", tall, tall2);
...
void  oppdaterDato(int* d, int* m, int* a)  {
  ...
  *m = lesTall("Maaned",    1,  12);
  *a = lesTall("Aar   ", 1950,2050);
}
