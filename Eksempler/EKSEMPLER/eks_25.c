...
int main ()  {
    ...
    if (tid.time < 12) printf("Dette er natt eller for lunsj.\n\n");
...
//****************************************************************************
    ...
    strcpy(person.navn,        "Kaare Larsen");
    ...
    person.fodselsDato = lesTall("Fodselsdato", 20000101, 20301231);
    printf("Persondata:\n\t%s\n\t%s\n\t%s\n\t%i\n\n",
           person.navn,         person.gateAdresse,
           person.postAdresse,  person.fodselsDato);
...
//****************************************************************************
    ...
    personer[0].fodselsDato = lesTall("Fodselsdato", 20000101, 20301231);
    ...
    do  {
      ...
      personer[antPers].fodselsDato =
                                   lesTall("Fodselsdato", 20000101, 20301231);
      antPers++;                            //  Antall personer lagt inn økes.
    ...
    funn = false;
    printf("\n\nPersoner fodt for den 10. i en maaned:  ");
