...
void maleriLesData(struct Maleri* maleri)  {
  ...
  maleri->aar    = lesInt("\tAar    ", 1500, 2100);
  maleri->bredde = lesInt("\tBredde",  MINMAAL, MAXMAAL);
  maleri->hoyde  = lesInt("\tHoyde ",  MINMAAL, MAXMAAL);
}
...
void skrivAltOmEttMaleri()  {
  ...
  if (gAntallMaleri > 0)  {                  //  Malerier finnes:
     ...
     printf("\n\tIngen malerier registrert/lagt inn ennaa!\n\n");
}
...
void skrivMalerierMedMinstemal()  {
  ...
  if (gAntallMaleri > 0)  {                    //  Malerier finnes:
    minstemaal = lesInt("Minstemaal for bredde ELLER hoyde", MINMAAL, MAXMAAL);
     ...
     printf("\n\tAntall malerier med dette minstemaalet:  %i\n", antall);
  } else                                        //  Malerier finnes IKKE:
     printf("\n\tIngen malerier registrert/lagt inn ennaa!\n\n");
}
  ...
  if (gAntallMaleri > 0)  {            //  Malerier finnes:
    ...
    if (!funn)                          //  Finnes ikke i noen by/på noe sted:
       printf("\n\tIngen malerier funnet %s!\n",
              (lokasjon == By ? "i denne by" : "paa dette sted"));
  } else                                //  Malerier finnes IKKE:
     printf("\n\tIngen malerier registrert/lagt inn ennaa!\n\n");
}
...
void skrivMeny()  {
  ...
  printf("\tM = skriv ALLE malerier med et Minstemaal (bredde eller hoyde)\n");
  printf("\tL = skriv ALLE malerier paa en gitt Lokasjon (by eller sted)\n");
