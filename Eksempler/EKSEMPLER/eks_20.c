...
int main() {
    char valg,                   //  Brukervalg til om fortsette eller ei.
         varer[][20] =           //  Navn på ALLE aktuelle varer i kiosken:
            { "Banan", "Eple", "Popcorn", "Potetgull", "Ostepop",
              "Kvikk-lunsj", "Japp", "Hobby", "Melkesjokolade", "Firklover",
              "Kroneis", "Lollipop", "Sandwich", "Pin-Up", "Baatis",
              "Smaagodt", "Sote drops", "Salte drops", "VG", "Dagbladet" };
    ...
    do {
        ...
        printf("Kjop av vare nr:\n");      //  Skriver vare-menyen:
        for (int i = 0;  i < MAXVARER;  i++)
            printf("%2i: %2i kr - %s\n", i+1, pris[i], varer[i]);
        printf(" 0: AVSLUTT denne kundens kjop\n\n");
