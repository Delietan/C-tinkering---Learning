...
int main ()  {
    ...
    printf("\nSkriv to tall (gjerne float) som inngaar i divisjon:  ");
    scanf("%f%f", &tall, &tall2);    //  Leser 2x verdier
    while (tall2 == 0)  {            //  Kan ikke dividere/dele med null:
      printf("\nAa dele med null er tull. ");
      printf("Derfor kan ikke det andre tallet være null. Prov igjen.\n");
      printf("Skriv det andre tallet (gjerne float) som inngaar i divisjonen:  ");
