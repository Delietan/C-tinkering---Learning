...
//**************************************************************************
    ...
    printf("Maanedsdager april    1999:  %i\n",     dageriMaaned( 4, 1999));
    printf("Maanedsdager desember 2002:  %i\n",     dageriMaaned(12, 2002));
    printf("Maanedsdager oktober  1995:  %i\n",     dageriMaaned(10, 1995));
    printf("Maanedsdager februar  2010:  %i\n",     dageriMaaned( 2, 2010));
    printf("Maanedsdager mai      1971:  %i\n",     dageriMaaned( 5, 1971));
    printf("Maanedsdager xxxxxx   2019:  %i\n\n\n", dageriMaaned(17, 2019));
