...
// Funksjoner som returnerer flere steder, og funksjoner som kaller hverandre:
    ...
    printf("Summering av broker etter 1!/1 + 2!/2 + 3!/3 + ... + N!/N :\n");
    printf("\tNaar 'N' er  5:  %8i\n",     summerBroker( 5));
    printf("\tNaar 'N' er  8:  %8i\n",     summerBroker( 8));
    printf("\tNaar 'N' er 12:  %8i\n\n\n", summerBroker(12));
...
//****************************************************************************
    ...
    lesTekst("1.tekst (av 4) aa vurdere", buffer);
    printf("\t-%s- er ", buffer);
    if (!palindrom(buffer)) printf("IKKE ");
    printf("et palindrom!\n\n");

    lesTekst("2.tekst (av 4) aa vurdere", buffer);  //  Mer kompakt skrivemåte:
    printf("\t-%s- er%s et palindrom!\n\n",
           buffer, ((!palindrom(buffer)) ? " IKKE" : ""));

    lesTekst("3.tekst (av 4) aa vurdere", buffer);
    printf("\t-%s- er%s et palindrom!\n\n",
           buffer, ((!palindrom(buffer)) ? " IKKE" : ""));

    lesTekst("4.tekst (av 4) aa vurdere", buffer);
    printf("\t-%s- er%s et palindrom!\n\n\n",
           buffer, ((!palindrom(buffer)) ? " IKKE" : ""));
