...
// ***************************************************************************
   ...
   printf("Skriv et aarstall: ");   scanf("%i", &aar);  //  Leser årstall.
                                                       //  Leser #dager i feb:
   ...
   printf("7.juni %i var dag nummer %i i det aaret.\n\n", aar, dagNummer);
...
//  Litt "leking" med H-filer ("ut av det blå"), for å vise et par muligheter:
    ...
    printf("Naavaerende tid i UK:  %s",   asctime(gmtime(&result)));
    printf("Naavaerende tid:       %s\n", asctime(localtime(&result)));
