...
int main()  {
    ...
    antPers = (int) lesTall("Antall personer aa lese inn data om", 1, MAXPERSONER);
    ...
    printf("\n\nTOTAL alder paa ALLE personene:           %i\n", totalAlder);
    printf("GJENNOMSNITTLIG vekt paa ALLE personene:  %.1f\n", totalVekt/antPers);
    printf("Eldste person er nr.%i (%s) med %i aar.\n\n", indeksEldst+1,
