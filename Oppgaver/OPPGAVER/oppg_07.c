...
int main()  {
    ...
    gjsnittSum = sum / 3.0;       //   (deler med 3.0 s� svaret blir en float)
    ...
    gjsnittKvadrat = kvadratSum / 3.0;   //  3.0 for � f� float-regnestykke.
    printf("Gjennomsnittet av deres kvadrater: %f\n", gjsnittKvadrat);

                                 //  Beregner og skriver sj.snitt av 2x float:
                                 //   S� lenge regnestykket best�r av float,
                                 //   s� holder det � dele med 2 (int)
