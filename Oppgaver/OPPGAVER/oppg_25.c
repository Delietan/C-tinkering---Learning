...
int main()  {
    ...
    printf("\t'POLSER M/SYLTETOY OG SOFTIS M/RAA LOK' har lengden:  %i\n",
           mstrlen("POLSER M/SYLTETOY OG SOFTIS M/RAA LØK"));
    ...
    printf("\nSTRCAT:\n");
    mstrcat(str1, str2);
    printf("\tSkjoter 'str1' med 'str2':  %s\n", str1);
    mstrcat(str1, " er kjaerester");
    printf("\tSkjoter 'str1' med ' er kjaerester':  %s\n", str1);
